...
""" 
This value is placed above the at 5m since we was establish that we have the uniform charge density 9being from [-5,5] and we were told that it was located at the midpoints.
"""




Ro = np.array([10, 0])  # Changed only use x-values, meaning that we have the Ro which is the charge of interested location at 5 means away from the final points notice that this is located

""" 
The value here is located at x=10m, since we know the length of the rod being from -5m to +5m as a result, we will have 10m be the location for the first part of the problem, This is important and setup that allows for the simpson rule to apply this distance
"""
